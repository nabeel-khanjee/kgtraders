...
class GetMarketCheck1Details {
  BaseUrl baseUrl = BaseUrl();

  Future<GetMarketCheck1Data> getMarketCheck1Details(appUrl) async {
    var now = null;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(response.body);
        return GetMarketCheck1Data.fromJson(jsonDecode(response.body));
      } else {
        return now;
      }
    } catch (e) {
