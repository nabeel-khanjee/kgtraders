                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      if (Welcome_List.isEmpty) {
                        ...
                        return searchController.text.isNotEmpty? orignalList():
                            
                            
                           Welcome_List1==null?orignalList(): searchedList();
                      }
                    } else {
                      return Center(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                              MyHomePageResidence(
                                            isHrDetails:
                                                Welcome_List1![index].isHr!,
                                            isSalarySlip:
                                                Welcome_List1![index].isSlip!,
                                            formFormate: "1",
                                            userId: widget.userId,
                                            userName: widget.userName,
                                            surveyId:
                                                Welcome_List1![index].surveyId!,
                                          ),
                                        ));
                                  } else if (Welcome_List1![index].type ==
                                      "Residence") {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                              MyHomePageResidence(
                                            isHrDetails:
                                                Welcome_List[index].isHr!,
                                            isSalarySlip:
                                                Welcome_List[index].isSlip!,
                                            formFormate: "1",
                                            userId: widget.userId,
                                            userName: widget.userName,
                                            surveyId:
                                                Welcome_List[index].surveyId!,
                                          ),
                                        ));
                                  } else if (Welcome_List[index].type ==
                                      "Residence") {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
